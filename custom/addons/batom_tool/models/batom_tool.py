...
class BatomCutterModel(models.Model):
    ...
    model_history_ids = fields.One2many('batom.cutter.model.history', 'cutter_model_id', domain=['|',('active','=',False),('active','=',True)], string='Model History List') # 履歷表
...
class BatomCutter(models.Model):
    ...
    history_ids = fields.One2many('batom.cutter.history', 'cutter_id', domain=['|',('active','=',False),('active','=',True)], string='History List') # 履歷表
